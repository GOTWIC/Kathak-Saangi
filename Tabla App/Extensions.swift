...
extension Color {
    ...
    public static let gold3: Color = Color(UIColor(red: 130/255, green: 90/255, blue: 30/255, alpha: 1.0))
    ...
    public static let white1: Color = Color(UIColor(red: 230/255, green: 230/255, blue: 230/255, alpha: 0.8))
